...
async function setButton(socket: WebSocket, button: HTMLButtonElement) {
...
async function init(socket: WebSocket, canvas: HTMLCanvasElement, button: HTMLButtonElement, result: HTMLDivElement) {
    if (canvas && result && socket) {
        // setButton(button, SOCKET!);
        setButton(socket, button)
